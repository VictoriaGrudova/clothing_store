...
class UI{
    ...
    // logLink(){
    //     const [loginForm, signUpForm] = document.querySelectorAll(".login-form");
    //     const [loginLink, signUpLink] = document.querySelectorAll(".log-link");
        ...
        .then(products => {
            switch (page) {
                ...
                case 'product':
                    ...
                    // ui.displayProductsAll(products);
                    // ui.getPopUp();
